...
def generate_mysql():
    ...
    sql ='CREATE TABLE IF NOT EXISTS listed_company (serial_number INT(20) NOT NULL,' \
         'stock_code INT(20) ,stock_abbre VARCHAR(20) ,company_name VARCHAR(20) ,' \
         'province VARCHAR(20) ,city VARCHAR(20) ,main_bussiness_income VARCHAR(20) ,' \
         'net_profit VARCHAR(20) ,employees INT(20) ,listing_date DATETIME(0) ,' \
         'zhaogushu VARCHAR(20) ,financial_report VARCHAR(20) , industry_classification VARCHAR(20) ,' \
         'industry_type VARCHAR(100) ,main_business VARCHAR(200) ,PRIMARY KEY (serial_number))'
